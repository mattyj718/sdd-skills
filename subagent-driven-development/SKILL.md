...
Read plan, extract all tasks with full text and context
  ...
  Dispatch implementer subagent (./implementer-prompt.md)
        |
  Questions? --yes--> Answer, provide context, re-dispatch
        |no
        v
...
[Note all 5 tasks and their order]
...
**Subagents follow red/green TDD for every task** (enforced in implementer prompt).
